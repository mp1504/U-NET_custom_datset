...
class myUnet(object):
    ...
    def train(self, _batch_size, _epochs, _verbose, _validation_split, _shuffle):
        print("loading data")
        ...
        print('Fitting model...')
        model.fit(x=imgs_train, y=imgs_mask_train, batch_size=_batch_size, epochs=_epochs, verbose=_verbose,
                  validation_split=_validation_split, shuffle=_shuffle , callbacks=[model_checkpoint])
...
if __name__ == '__main__':
    ...
    myunet.train(args.batch_size, args.epochs, args.verbose, args.validation_split, args.shuffle)
    myunet.save_img()
